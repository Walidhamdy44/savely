...
/** GitHub connect form for entering a username and connecting. */
export function GitHubConnect() {
  const [username, setUsername] = useState("");
  const { connect } = useGitHubMutation();
...
/** Large GitHub logo for the connect card. */
function GitHubLogo() {
  return (
